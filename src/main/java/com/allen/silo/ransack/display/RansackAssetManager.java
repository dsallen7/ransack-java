...
public class RansackAssetManager extends AssetManager {
	...
	static{
		fileHandleResolver = new FallbackFileHandleResolver(new InternalFileHandleResolver(), new ExternalFileHandleResolver(), new TestExternalFileHandleResolver());
	}
	
	public RansackAssetManager(){
		super(fileHandleResolver);
	    setLoader(UiTheme.class, new UiThemeLoader(this.getFileHandleResolver()));
	    //load("village1.tmx", TiledMap.class);
